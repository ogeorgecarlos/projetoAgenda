...
/***/ "./frontend/modules/cadastroUser.js":
/*!******************************************!*\
  !*** ./frontend/modules/cadastroUser.js ***!
  \******************************************/
...
/* harmony export */   "default": () => (/* binding */ CadastroUser)
/* harmony export */ });
...
var CadastroUser = /*#__PURE__*/function () {
  function CadastroUser(classe) {
    _classCallCheck(this, CadastroUser);
    this.form = document.querySelector(".".concat(classe));
  }
  return _createClass(CadastroUser, [{
    key: "init",
    value: function init() {
      this.controlSubmit();
    }
    ...
    key: "controlSubmit",
    value: function controlSubmit() {
      var _this = this;
      this.form.addEventListener("submit", function (e) {
        e.preventDefault();
        if (_this.valida()) _this.form.submit();
      });
    }
  }, {
    key: "valida",
    value: function valida() {
      var nameIsValid = this.checkNameField();
      var telisValid = this.checkTelField();
      var EmailisValid = this.checkEmailField();
      if (this.form.querySelector("input[name=telefone]").value === "" && this.form.querySelector("input[name=email]").value === "") {
    ...
    key: "checkNameField",
    value: function checkNameField() {
      var NameInput = this.form.querySelector("input[name=nome]");
      var nameInputValue = NameInput.value;
      if (!nameInputValue) {
        this.createError(NameInput, "Campo \"".concat(NameInput.previousElementSibling.innerText, "\" inv\xE1lido"));
        return false;
      }
      return true;
    }
    ...
    key: "checkTelField",
    value: function checkTelField() {
      var telInput = this.form.querySelector("input[name=telefone]");
      var telInputValue = telInput.value;
      var telRegex = new RegExp(/^\(?[1-9]{2}\)?\s?[9][0-9]{4}\-?[0-9]{4}$/);
      if (telInputValue && !telRegex.test(telInputValue)) {
        this.createError(telInput, "Campo \"".concat(telInput.previousElementSibling.innerText, "\" inv\xE1lido"));
        return false;
      }
      return true;
    }
    ...
    value: function checkEmailField() {
      ...
      var mailRegex = new RegExp(/^[a-z0-9.]+@[a-z0-9]+\.[a-z]+(\.[a-z]+)?$/, "i");
      if (emailInputValue && !mailRegex.test(emailInputValue)) {
        console.log("aqui");
        this.createError(emailInput, "Campo \"".concat(emailInput.previousElementSibling.innerText, "\" inv\xE1lido"));
        return false;
      }
      return true;
    }
    ...
    key: "createError",
    value: function createError(input, errorMessage) {
      if (!input || !errorMessage) console.log("Falta campos para gerar o erro.");
      var proxElemento = input.nextElementSibling;
...
var Login = /*#__PURE__*/function () {
  ...
  return _createClass(Login, [{
    ...
    key: "submitControl",
    value: function submitControl() {
      var _this = this;
      this.form.addEventListener("submit", function (e) {
        e.preventDefault();
        var emailIsValid = _this.emailIsValid();
        var passwordIsValid = _this.passwordIsValid();
        if (emailIsValid && passwordIsValid) _this.form.submit();
      });
    }
  }, {
    key: "emailIsValid",
    value: function emailIsValid() {
      ...
      var ErrorParagraph = this.form.querySelector(".error-paragraph-email");
    ...
    key: "passwordIsValid",
    value: function passwordIsValid() {
      var passwordInput = this.form.querySelector("input[name=password]");
      var password = passwordInput.value;
      var maxLength = 50;
      var minLength = 3;
      var ErrorParagraph = this.form.querySelector(".error-paragraph-password");
      if (password.length > maxLength || password.length < minLength) {
        if (!ErrorParagraph) {
          var newParagraph = document.createElement("p");
          newParagraph.setAttribute("class", "error-paragraph-password");
          newParagraph.innerHTML = "A senha deve ter entre ".concat(minLength, " e ").concat(maxLength, " caracteres");
          passwordInput.insertAdjacentElement("afterEnd", newParagraph);
          return false;
        }
        ErrorParagraph.innerHTML = "A senha deve ter entre ".concat(minLength, " e ").concat(maxLength, " caracteres");
        return false;
      }
      if (ErrorParagraph) ErrorParagraph.remove();
      return true;
...
/* harmony import */ var _modules_cadastroUser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/cadastroUser */ "./frontend/modules/cadastroUser.js");
...
var locationPage = document.location.pathname;
switch (locationPage) {
  case "/login-index":
    console.log("aqui1");
    var register = new _modules_login__WEBPACK_IMPORTED_MODULE_2__["default"]("login-register");
    var login = new _modules_login__WEBPACK_IMPORTED_MODULE_2__["default"]("login-login");
    register.init();
    login.init();
    break;
  case "/userpage-add":
    var cadastroUser = new _modules_cadastroUser__WEBPACK_IMPORTED_MODULE_3__["default"]("cadastro-user");
    cadastroUser.init();
    break;
  case /\/userpage-editForm.*/:
    var editUser = new _modules_cadastroUser__WEBPACK_IMPORTED_MODULE_3__["default"]("edit-user");
    editUser.init();
    break;
  default:
    break;
